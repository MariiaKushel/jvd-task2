...
public class EllipseFactoryTest {
	...
	public void testCreateEllipse1 (Ellipse expected, double...coordinates) {
	...
	public void testCreateEllipse2 (double...coordinates) {
		Ellipse actual = EllipseFactory.createEllipse(coordinates);
	...
	public void testCreateEllipse3 (Ellipse expected, double aX, double aY, double bX, double bY) {
	...
	public void testCreateEllipse4 (double aX, double aY, double bX, double bY) {
		Ellipse actual = EllipseFactory.createEllipse(aX, aY, bX, bY);
		Assert.assertNull(actual);
	}
	...
	public void testCreateEllipse5 (Ellipse expected, Point a, Point b) {
	...
	public void testCreateEllipse6 (Point a, Point b) {
		Ellipse actual = EllipseFactory.createEllipse(a, b);
		Assert.assertNull(actual);
	}
